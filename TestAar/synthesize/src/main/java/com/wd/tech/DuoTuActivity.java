...
public class DuoTuActivity extends AppCompatActivity {


    private static final String TAG = "DuoTuActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duo_tu);
    ...
    private void initAdapter() {
        ...
        adapter.setListener(new SelectPlotAdapter.CallbackListener() {
            ...
            public void add() {
                ...
                Tools.galleryPictures(DuoTuActivity.this, size);
            }
            ...
            public void item(int position, List<String> mList) {
                ...
                //①、图片选择器自带预览
                PictureSelector.create(DuoTuActivity.this)
