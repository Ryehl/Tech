package com.bw.mylibrary.exercis;
...
public class DeviceInfoUtils {
    ...
    static final String TAG = "DeviceInfoUtils";
    ...
    public static String getDeviceSupportLanguage() {
        Log.e(TAG, "Local:" + Locale.GERMAN);
        Log.e(TAG, "Local:" + Locale.ENGLISH);
        Log.e(TAG, "Local:" + Locale.US);
        Log.e(TAG, "Local:" + Locale.CHINESE);
        Log.e(TAG, "Local:" + Locale.TAIWAN);
        Log.e(TAG, "Local:" + Locale.FRANCE);
        Log.e(TAG, "Local:" + Locale.FRENCH);
        Log.e(TAG, "Local:" + Locale.GERMANY);
        Log.e(TAG, "Local:" + Locale.ITALIAN);
        Log.e(TAG, "Local:" + Locale.JAPAN);
        Log.e(TAG, "Local:" + Locale.JAPANESE);
