...
public class SearchArticleAdapter extends RecyclerView.Adapter<SearchArticleAdapter.ViewHolder> {
    private List<SearchArticleBean.ResultBean> list;

    public SearchArticleAdapter(List<SearchArticleBean.ResultBean> list) {
        this.list = list;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=View.inflate(parent.getContext(), R.layout.searcharticle_item,null);
